...
def build_heap_tree(heap, index=0):
    ...
    # Створюємо вузол для поточного індексу
    node = Node(heap[index])
    
    # Рекурсивно додаємо лівого та правого нащадків
...
# Приклад купи (масив)
# Представлення min-heap для даних з вашого скріншоту
...
# Візуалізація
print(f"Візуалізація купи: {heap_list}")
draw_tree(heap_root)